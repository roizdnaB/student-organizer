...
@Component({
  selector: 'app-lecturers-add',
  templateUrl: './lecturers-add.component.html',
  styleUrls: ['./lecturers-add.component.css']
})
export class LecturersAddComponent implements OnInit {
  dataForm: FormGroup;
  lecturer: Lecturer = {};


  constructor(
    public dialogRef: MatDialogRef<LecturersAddComponent>,
    ...
    onSubmit(): void {
      if (this.dataForm.invalid) {
        ...
        this.data = this.lecturer;

        this.service.addLecturer(this.lecturer)
          .pipe(first())
          .subscribe(() => {});
      }
    }
